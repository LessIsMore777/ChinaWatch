 ...
 * 主要作用：已启用的技能(实体)
 */
public class SkillManagerTrueBean {
     ...
     * 开启编辑模式的时候，调用这个构造
     */
    public SkillManagerTrueBean(String skillName, Drawable skillImage, Drawable skillAddOrDelete, boolean addOrDelete) {
     ...
     * 不调用编辑模式的时候，调用这个构造
     */
    public SkillManagerTrueBean(String skillName, Drawable skillImage) {
        this.skillName = skillName;
        this.skillImage = skillImage;
    }
