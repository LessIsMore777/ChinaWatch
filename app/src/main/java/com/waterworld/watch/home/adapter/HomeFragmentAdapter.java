...
public class HomeFragmentAdapter extends RecyclerView.Adapter<HomeFragmentAdapter.MyHolder> {
    ...
    private final String TAG = "HomeFragmentAdapter";
    private Context mContext;
    private List<SkillManagerTrueBean> mData;

    public HomeFragmentAdapter(Context mContext, List<SkillManagerTrueBean> mData) {
    ...
    public List<SkillManagerTrueBean> getMData(){
        return mData;
    }
    ...
    public void setAddSkillClick(HomeFragmentAdapter.addSkillClick addSkillClick) {
