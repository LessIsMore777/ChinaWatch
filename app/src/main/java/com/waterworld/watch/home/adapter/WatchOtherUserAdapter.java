 ...
 * 时间：2018/12/6 11:23
 * 主要作用：宝贝与其他用户的绑定列表(适配器)
 */
public class WatchOtherUserAdapter extends RecyclerView.Adapter<WatchOtherUserAdapter.MyHolder> {

    private Context mContext;
    private List<WatchOtherUserBean> mData;

    public WatchOtherUserAdapter(Context mContext, List<WatchOtherUserBean> mData) {
