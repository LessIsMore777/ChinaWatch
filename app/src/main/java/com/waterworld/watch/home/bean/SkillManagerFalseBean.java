 ...
 * 主要作用：未启用的技能(实体)
 */
public class SkillManagerFalseBean {
    ...
    public SkillManagerFalseBean(String skillName, Drawable skillImage, Drawable skillAddOrDelete, boolean isEdit) {
    ...
    public SkillManagerFalseBean(String skillName, Drawable skillImage){
        this.skillName = skillName;
        this.skillImage = skillImage;
    }
