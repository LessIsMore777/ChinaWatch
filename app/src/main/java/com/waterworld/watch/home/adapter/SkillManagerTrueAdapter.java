 ...
 * 主要作用：已启用的技能列表(适配器)
 */
public class SkillManagerTrueAdapter extends RecyclerView.Adapter<SkillManagerTrueAdapter.MyHolder> {
    ...
    public SkillManagerTrueAdapter(Context mContext, List<SkillManagerTrueBean> mData, int leftRight, int topBottom, int spanCount, int screenWidth) {
