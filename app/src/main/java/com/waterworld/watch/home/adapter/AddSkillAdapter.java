 ...
 * 主要作用：
 */
public class AddSkillAdapter extends RecyclerView.Adapter<AddSkillAdapter.MyHolder> {

    private Context mContext;
    private List<AddSkillBean> mData;

    public AddSkillAdapter(Context mContext, List<AddSkillBean> mData) {
