...
import com.waterworld.watch.home.adapter.MySkillAdapter;
import com.waterworld.watch.home.adapter.AddSkillAdapter;
import com.waterworld.watch.home.bean.AddSkillBean;
 ...
 * 主要作用：编辑技能的界面
 */
public class ManagerSkillActivity extends BaseActivity implements View.OnClickListener {

    private final String TAG = "ManagerSkillActivity";
    private ManagerSkillActivity addSkillActivity;
    /**
     * 头部组件
     */
    ...
    private List<MySkillBean> mySkillData;
    /**
     * 增加应用
     */
    ...
    private List<AddSkillBean> addSkillData;
    ...
    private void initView() {
        ...
        setViewSize(header_parent, ViewGroup.LayoutParams.MATCH_PARENT, ScreenAdapterUtil.getHeightPx(addSkillActivity) / 11);
    ...
    private void initAddSkillRecycler(){
        ...
        addSkillData.add(new AddSkillBean("打电话", getResources().getDrawable(R.drawable.ic_skill_phone)));
        addSkillData.add(new AddSkillBean("通讯录", getResources().getDrawable(R.drawable.ic_skill_contact)));
        addSkillData.add(new AddSkillBean("单项聆听", getResources().getDrawable(R.drawable.ic_skill_listener)));
        addSkillData.add(new AddSkillBean("远程拍摄", getResources().getDrawable(R.drawable.ic_skill_switch)));

        addSkillAdapter = new AddSkillAdapter(this,addSkillData);
    ...
    private void initMySkillRecycler() {
        ...
        mySkillData.add(new MySkillBean("打电话", getResources().getDrawable(R.drawable.ic_skill_phone)));
        mySkillData.add(new MySkillBean("通讯录", getResources().getDrawable(R.drawable.ic_skill_contact)));
        mySkillData.add(new MySkillBean("单项聆听", getResources().getDrawable(R.drawable.ic_skill_listener)));
        mySkillData.add(new MySkillBean("远程拍摄", getResources().getDrawable(R.drawable.ic_skill_switch)));
        mySkillData.add(new MySkillBean("打电话", getResources().getDrawable(R.drawable.ic_skill_phone)));
        mySkillData.add(new MySkillBean("通讯录", getResources().getDrawable(R.drawable.ic_skill_contact)));
        mySkillData.add(new MySkillBean("单项聆听", getResources().getDrawable(R.drawable.ic_skill_listener)));
        mySkillData.add(new MySkillBean("远程拍摄", getResources().getDrawable(R.drawable.ic_skill_switch)));
        ...
        mySkillData.add(new MySkillBean("单项聆听", getResources().getDrawable(R.drawable.ic_skill_listener)));
        mySkillData.add(new MySkillBean("远程拍摄", getResources().getDrawable(R.drawable.ic_skill_switch)));
        mySkillAdapter = new MySkillAdapter(this, mySkillData, 18, 18, 3, ScreenAdapterUtil.getWidthPx(this));
        //Recycler设置布局类型
        layoutManager = new LinearLayoutManager(this);
        layoutManager.setOrientation(LinearLayoutManager.VERTICAL);
